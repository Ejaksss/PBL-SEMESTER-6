<x-guest-layout>
    ...
    <div class="space-y-3 mb-6">
       ...
       class="w-full flex items-center justify-center gap-3 border border-gray-700 rounded-xl py-2.5 hover:border-[#EAB308] hover:text-[#EAB308] transition text-white">
