    ...
    <div class="min-h-screen bg-[#0c0c0c] text-white font-sans">
        ...
        <div class="relative bg-[#111] border-b border-[#EAB308]/30 py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                @php
                    $res = Auth::user()->reservations()->latest()->first();
                @endphp

                <!-- Jika Belum Ada Reservasi (Empty State ala Button Figma) -->
                @if(!$res)
                    <a href="{{ route('booking.create') }}" class="bg-[#EAB308] text-black px-10 py-4 rounded-full font-black uppercase tracking-widest hover:bg-yellow-400 hover:scale-105 transition shadow-lg shadow-yellow-500/20">
                    Reservasi Sekarang
                    </a>
                @endif
            </div>
